 ...
 * ------------------------ */
  ...
  /**
   * Construct a diagonal matrix from another matrix (of any kind) by extracting the elements on the
   * diagonal.
   *
 ...
 * ------------------------ */
  ...
  /**
   * Multiplies the transposed matrix by an array, y = A'*x. Since a diagonal matrix is equal to its
   * transposed y = A*x
   *
