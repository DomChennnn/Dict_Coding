 ...
 * ------------------------ */
  ...
  /**
   * Set the matrix (this = A) to B*s, A = B*s. Note that since this matrix (A) is symmetric only
   * lower left part of B is used.
   *
  ...
  /**
   * Permute the rows of matrix B and put result in this, A = P * B. Note that the result usually is
   * not a symmetric matrix, but symmetry in A is kept anyway so result will probably be wrong.
   *
  ...
  /**
   * Permute the columns of matrix B and put result in this, A = B * P. Note that the result usually
   * is not a symmetric matrix, but symmetry in A is kept anyway so result will probably be wrong.
   *
   * @param B Matrix of size N-by-K, size of result (this) is also N-by-K
  ...
  /**
   * Scale the rows of matrix B and put result in this, A = D * B. Note that the result usually is
   * not a symmetric matrix, but symmetry in A is kept anyway so result will probably be wrong.
   *
   * @param D Diagonal matrix of size N-by-N, class DiagonalMatrix
   * @param B Matrix of size N-by-K, size of result (this) is also N-by-K
  ...
  /**
   * Scale the columns of matrix B and put result in this, A = B * D. Note that the result usually
   * is not a symmetric matrix, but symmetry in A is kept anyway so result will probably be wrong.
   *
   * @param B Matrix of size N-by-K, size of result (this) is also N-by-K
   * @param D Diagonal matrix of size N-by-N, class DiagonalMatrix
 ...
 * ------------------------ */
  ...
  /**
   * Add outer product of two vectors to this, A = s1*A + s2*(u*v'+v*u'). Note that this method is
   * different for a SymmetricMatrix than for other matrices, (AllMatrices).
   *
  ...
  /**
   * Add outer product of a vector to scaled this, A = s1*A + s2*(u*u'). This matrix, A, is of size
   * N-by-N. Each element is updated as: A(n,k) = s1*A(n,k) + s2*u(n)*u(k) Note that this method is
   * like the one with two arguments vectors for other matrices, (AllMatrices).
   *
   * @param s1 A single value
   * @param s2 A single value
   * @param u  A vector with N elements
