 ...
 * ------------------------ */
  ...
  /**
   * Construct a Block matrix with four submatrices, [A, B; C, D]. The dimensions for the
   * submatrices must agree. Note that some of the matrices may be null, legal use is like: <BR>
   * BlockMatrix(A,B,C,D); BlockMatrix(A,B,null,null); BlockMatrix(A,null,C,null);
   * BlockMatrix(A,null,null,D); BlockMatrix(A,B,C,null);BlockMatrix(A,B,null,D);
   *
  ...
  * ------------------------ */
  ...
  /**
   * Copy a column of the matrix into argument y Legal range of the integer argument is <code>0 <= k
