 ...
 * <P><PRE>
 * double[][] vals = {{1.,2.,3},{4.,5.,6.},{7.,8.,10.}}; JamaMatrix A = new JamaMatrix(vals);
 * JamaMatrix b = JamaMatrix.random(3,1); JamaMatrix x = A.solve(b); JamaMatrix r =
 ...
 * ------------------------ */
   ...
   * JamaMatrix this is the same as (deep) copy (or clone). Note that argument B may be another kind
   * of matrix, ex. an object of class SparseMatrix or BandMatrix or any subclass of AllMatrices
   *
